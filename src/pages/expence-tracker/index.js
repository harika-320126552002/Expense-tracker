...
export const ExpenseTracker = () => {
  ...
  const transactionData = transactions.reduce((acc, transaction) => {
    ...
    acc[transactionType] = acc[transactionType] || 0;
    acc[transactionType] += parseFloat(transactionAmount);
    return acc;
  }, {});
    ...
    datasets: [
      {
        ...
        backgroundColor: toggle ? "red" : "green", // Adjust color based on theme
      ...
      >
        ...
        <table>
          <thead>
            <tr
              className="headtabl"
              style={{ backgroundColor: toggle ? "#313131" : "#ffffff" }}
            >
              <th>Description</th>
              <th>Amount</th>
              <th>Type</th>
